...
class GVScreenHome extends StatefulWidget {
  final AppUser giangvien;
  const GVScreenHome({Key? key, required this.giangvien}) : super(key: key);

  @override
  State<GVScreenHome> createState() => _GVScreenHomeState();
}

class _GVScreenHomeState extends State<GVScreenHome> {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => PostDetailScreen(
              post: post,
              currentUserId: widget.giangvien.id!,
              userview: widget.giangvien,
            ),
          ),
        );
      },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: Mydrawer(
          ...
          user: widget.giangvien),
      appBar: AppBar(
        iconTheme: const IconThemeData(color: Colors.white),
        title: Text('Trang chủ', style: textsimplewhitebigger),
        centerTitle: true,
